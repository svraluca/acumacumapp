...
class GNav extends StatefulWidget {
  const GNav({super.key, 
    ...
    required this.tabBackgroundGradient,
  });
...
class _GButtonState extends State<GButton> {
  ...
  Widget build(BuildContext context) {
    return Button(
      ...
      curve: widget.curve,
      icon: widget.leading ??
          Icon(widget.icon, color: widget.active ? widget.iconActiveColor : widget.iconColor, size: widget.iconSize),
      text: Text(
        widget.text,
                    ...
                    children: <Widget>[
                      SizeTransition(
                        ...
                        child: AnimatedOpacity(
                          ...
                          child: Container(
                              margin: EdgeInsets.only(left: widget.gap + widget.iconSize),
